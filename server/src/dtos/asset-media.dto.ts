...
export enum ReadThumbnailBytesFormatEnum {
  JPEG = 'JPEG',
  WEBP = 'WEBP',
}

export class ReadThumbnailBytesDto {
  @Optional()
  @IsEnum(ReadThumbnailBytesFormatEnum)
  @ApiProperty({
    type: String,
    enum: ReadThumbnailBytesFormatEnum,
    default: ReadThumbnailBytesFormatEnum.WEBP,
    required: false,
    enumName: 'ThumbnailFormat',
  })
  format: ReadThumbnailBytesFormatEnum = ReadThumbnailBytesFormatEnum.WEBP;
}

export class ReadOriginalBytesDto {
  @ValidateBoolean({ optional: true })

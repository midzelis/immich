import { createZoomImageWheel as _createZoomImageWheel } from '$lib/zoom-image-core';
import { onDestroy } from 'svelte';
import { writable } from 'svelte/store';

import type { ZoomImageWheelState, ZoomImageWheelStateUpdate } from '$lib/zoom-image-core';
